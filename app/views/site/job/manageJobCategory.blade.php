...
{{ $header->setMetaTitle('Manage Job Category') }}
{{ $header->setPageTitle(trans('site/jobData.manage_job_category.list_page_title_head')) }}
<?php
...
@section('content')
 ...
 <script>
    ...
    function editRecord(id)
    {
        ...
        $('#fnLoading').show();
        $('#fn_btnholder').hide();
        var url = '{{ URL::to('job/job-category-info')}}?id='+id;
